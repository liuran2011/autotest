...
class Ui_nfcProjectForm(object):
    def setupUi(self, nfcProjectForm):
        ...
        self.vmTableWidget = QtWidgets.QTableWidget(self.tab_3)
        self.vmTableWidget.setObjectName("vmTableWidget")
        self.vmTableWidget.setColumnCount(3)
        self.vmTableWidget.setRowCount(0)
        item = QtWidgets.QTableWidgetItem()
        self.vmTableWidget.setHorizontalHeaderItem(0, item)
        item = QtWidgets.QTableWidgetItem()
        self.vmTableWidget.setHorizontalHeaderItem(1, item)
        item = QtWidgets.QTableWidgetItem()
        self.vmTableWidget.setHorizontalHeaderItem(2, item)
        self.horizontalLayout_10.addWidget(self.vmTableWidget)
        ...
        self.testResultTreeWidget.setRowCount(0)
        item = QtWidgets.QTableWidgetItem()
    ...
    def retranslateUi(self, nfcProjectForm):
        ...
        item = self.vmTableWidget.horizontalHeaderItem(1)
        item.setText(_translate("nfcProjectForm", "虚拟机UUID"))
        item = self.vmTableWidget.horizontalHeaderItem(2)
        ...
        self.label_10.setText(_translate("nfcProjectForm", "测试开始时间:"))
        self.label_11.setText(_translate("nfcProjectForm", "测试停止时间:"))
        item = self.testResultTreeWidget.horizontalHeaderItem(0)
        item.setText(_translate("nfcProjectForm", "测试项"))
        item = self.testResultTreeWidget.horizontalHeaderItem(1)
        item.setText(_translate("nfcProjectForm", "测试结果"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_4), _translate("nfcProjectForm", "测试结果"))
